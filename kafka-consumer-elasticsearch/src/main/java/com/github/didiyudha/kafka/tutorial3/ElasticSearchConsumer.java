package com.github.didiyudha.kafka.tutorial3;
...
public class ElasticSearchConsumer {
    public static RestHighLevelClient createClient() {
        String hostname = "kafka-playground-9365978025.ap-southeast-2.bonsaisearch.net";
        String username = "zuctr5jwik";
        String password = "zaqtzkiv79";
